...
import { OUTRO, PROFILE, NAV } from '../../data/content'
      ...
      <div className="relative z-10 mx-auto w-[min(1150px,92vw)]">
        <div className="text-center mb-10">
          <span className="font-impact text-stroke comic-shadow text-tt-yellow"
            style={{ fontSize: 'clamp(2rem,6vw,4rem)' }}>MISSION COMPLETE!</span>
        </div>
        ...
        <div className="mt-14 text-center">
          <div className="font-display text-3xl md:text-4xl text-white text-stroke-thin">AMAN ULLAH KAZI</div>
          <div className="font-display text-tt-pink text-xl mt-1">created, directed & coded by the new Titan</div>
          ...
          <p className="mt-6 text-white/40 text-xs">© {new Date().getFullYear()} {PROFILE.name}. All rights reserved. Built with React, GSAP, Framer Motion & Lenis.</p>
        </div>
